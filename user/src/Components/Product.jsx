        ...
        <div>
            <div className='flex items-center justify-between px-3 py-0'>
                <ul className='flex items-center text-xl gap-10 text-gray-700 text-sm font-semibold text-2xl mb-5'>
                    <li className={`hover:text-red-600 cursor-pointer ${activeCategory === 'Fashion' ? 'text-red-600' : ''}`} onClick={() => setActiveCategory('Fashion')}>Fashion</li>
                    <li className={`hover:text-red-600 cursor-pointer ${activeCategory === 'Electronic' ? 'text-red-600' : ''}`} onClick={() => setActiveCategory('Electronic')}>Electronic</li>
                    <li className={`hover:text-red-600 cursor-pointer ${activeCategory === 'Furniture' ? 'text-red-600' : ''}`} onClick={() => setActiveCategory('Furniture')}>Furniture</li>
                </ul>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-0">
                <div className="border-[1px] border-gray-300 relative group">
                    <div className='px-4  w-full h-60 bg-white flex items-center justify-center'>
                    ...
                    <div>
                        <p className='absolute top-3 left-4 text-red-500 bg-red-600 text-white text-[11px] p-1 px-2 rounded-sm'>-12%</p>
                        <p className='absolute top-10 left-1 transition-all duration-500 invisible opacity-0 group-hover:opacity-100 group-hover:visible group-hover:left-4 text-red-500 bg-green-600 text-white text-[11px] p-1 px-[10px] rounded-sm'>New</p>
                    ...
                    <div className='ml-5'>
                        ...
                        <p className='text-md mt-2'>Apple Smart Watch / Midnight Aluminum</p>
                        ...
                        <p className='mb-7 text-red-600 font-semibold'><span className='text-gray-500 mr-2 font-normal'><del>$58.00</del></span>$51.40</p>
                    </div>
                </div>
                <div className="border-[1px] border-gray-300 relative group">
                    <div className='px-4  w-full h-60 bg-white flex items-center justify-center'>
