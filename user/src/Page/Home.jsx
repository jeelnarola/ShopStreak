...
export default function Home() {
  ...
  return (
    <div className=" ">
        ...
        <div className="container mx-auto ">
          <div className="flex flex-col md:flex-row gap-6  ">
            ...
            <div className="w-[1000px] bg-blue-100 rounded-xl relative ">
              <img src={banner1} alt="Modern Chair" className="w-full h-full" />
              <div className="md:text-left absolute top-1/5 px-7 left-1/2 translate-x-1/10 translate-x-1/15 ">
                <p className="text-black text-lg lading-9">
      ...
      <div className="container mx-auto my-20 ">
        <div class="px-10 border border-red-400 rounded-md h-[100px] rounded-lg overflow-hidden flex flex-col md:flex-row items-center justify-between p-4 text-center md:text-left gap-4">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="font-bold text-black text-3xl mr-20 ml-10">
              FREE SHIPPING
            </span>
          ...
          {/* <!-- Right: Price --> */}
          <div class="font-bold text-black text-3xl">- ONLY $200*</div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-3 gap-4 justify-center p-6 bg-white">
          ...
          <div class="flex items-center bg-blue-100 rounded-md w-full  gap-4 relative overflow-hidden cursor-pointer group">
            <img
              src={cms}
              alt="Samsung S22"
              class="w-full h-auto object-contain hover:scale-115 transition-all duration-2000"
            />
            <div className="absolute top-10 right-10 text-black px-2 py-1 rounded-bl-md">
              ...
              <a
                href="#"
                class="text-sm underline font-medium text-black hover:text-blue-600"
              >
                SHOP NOW
              </a>
            </div>
      ...
      <div className="container mx-auto my-20">
        <Product name={["Fashion", "Electronic", "Furniture"]} />
      </div>
      <div className="container mx-auto my-20 relative group overflow-hidden">
        <div>
          <img
            src={offbanner}
            alt=""
            className="w-full group-hover:scale-107 transform-all duration-2000"
          />
        </div>
        <div className="absolute top-6 left-0  right-0 m-auto text-white translate-x-1/3 flex items-center ">
